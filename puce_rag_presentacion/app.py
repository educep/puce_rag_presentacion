...
<img src="{aws_path}/PRESENTACION+PUCE/08-trainable-parameters.png" alt="LLM structure" style="width: 800px; height: auto;">
  ...
  <h3 style="font-size: 0.9em; text-align: left; color: #007BFF; text-transform: none;">Recursos Importantes</h3>

  <p style="font-size: 0.7em; text-align: left;">Artículo original: 
  ...
  <div style="font-size: 0.9em; text-align: left; list-style-type: disc; margin-left: 5px;">
...
<p style="font-size: 0.9em; text-align: left;">Artículo original: 
<a target="_blank" href="https://arxiv.org/abs/1706.03762" style="font-size: 0.7em; text-align: left; color: #FF5733; text-decoration: none;">
  Vaswani, A. "Attention is all you need." Advances in Neural Information Processing Systems (2017)
</a>
</p>
...
<div>
<p>Encuétrame en <a target="_blank" href="https://www.linkedin.com/in/educep/">LinkedIn <img src="{aws_path}/PRESENTACION+PUCE/LILOGO.png" alt="GitHub Logo" style="width: 50px; height: auto;"></a></p>
<p>Código: <a target="_blank" href="https://github.com/huggingface/transformers/tree/main/examples/research_projects/distillation">GitHub <img src="https://github.githubassets.com/images/modules/logos_page/GitHub-Mark.png" alt="GitHub Logo" style="width: 50px; height: auto;"></a></p>
</div>
"""
